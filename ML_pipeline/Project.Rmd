...
hds<- hds %>% 
  add_column(Ethnicity_7 = ifelse(hds$Ethnicity_2+hds$Ethnicity_5+hds$Ethnicity_6==0,1,0), .after = "Ethnicity_6")
...
down_train<- down_train %>% select(-c(Ethnicity_2, Ethnicity_5, Ethnicity_6))
dataTest<- dataTest %>% select(-c(Ethnicity_2, Ethnicity_5, Ethnicity_6, Ethnicity_7))
```
